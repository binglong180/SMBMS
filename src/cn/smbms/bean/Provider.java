...
public Provider(Integer id, String proCode, String proName, String proDesc,
		...
		Integer createdBy, Date creationDate, Date modifyDate, Integer modifyBy) {
	super();
	this.id = id;
...
public String toString() {
	return "Provider [id=" + id + ", proCode=" + proCode + ", proName="
			+ proName + ", proDesc=" + proDesc + ", proContact=" + proContact
			+ ", proPhone=" + proPhone + ", proAddress=" + proAddress
			+ ", proFax=" + proFax + ", createdBy=" + createdBy
